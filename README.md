...
- The Executive dashboard separates composite readiness from throughput utilization: ACRS remains a weighted readiness score, while Capacity Position shows current versus forecast utilization at the most constrained endpoint (projected RPS / assumed safe RPS).
